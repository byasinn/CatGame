...
class Level3:
    def __init__(self, window: Surface, game_mode: str, player_score: list[int], audio=None):
        ...
        # Fundo da fase
        self.entity_list.extend(EntityFactory.get_entity("Level3Bg"))
    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            # Quando a fase completa, spawna o boss
            if event_result == "complete" and not self.boss_spawned:
                boss = EntityFactory.get_entity("Boss")
                self.entity_manager.get_entities().append(boss)
            ...
            self.hud.draw_hud(
                ...
                boss_summoned=self.boss_spawned,
                fps=clock.get_fps(),
